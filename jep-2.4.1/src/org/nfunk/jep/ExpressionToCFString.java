...
public class ExpressionToCFString {

    public String toCFString(JEP jepExpression) {
        try {
            ToCFStringVisitor visitor = new ToCFStringVisitor(jepExpression);
...
class ToCFStringVisitor implements ParserVisitor {

    private JEP jepExpression;
    private StringBuffer result = new StringBuffer();

    public ToCFStringVisitor(JEP jepExpression) {
