...
public class Variable implements Cloneable {
    ...
    private Object originalDescription;
    ...
    protected Variable(String name) {
        ...
        this.originalDescription = new String(name);
        this.value = null;
        validValue = false;
    }
    ...
    public Object getOriginalDescription() {
        return originalDescription;
    }

    public void setOriginalDescription(Object originalDescription) {
    ...
    public String toString() {
        if (!validValue || value == null)
            ...
            return name + " ( " + description + "): " + value.toString() + " (Constant)";
        else
            return name + " ( " + description + "): " + value.toString();
    }
}
