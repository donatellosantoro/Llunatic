...
public class ChaseStats {
    ...
    public static final String NUMBER_OF_SOURCE_TABLES = "#Source Tables";
    public static final String NUMBER_OF_SOURCE_ATTRIBUTES = "#Source Attributes";
    public static final String NUMBER_OF_TARGET_TABLES = "#Target Tables";
    public static final String NUMBER_OF_TARGET_ATTRIBUTES = "#Target Attributes";
    public static final String NUMBER_OF_STTGDS = "#Source-to-Target TGDs";
    public static final String NUMBER_OF_EXTGDS = "#Target TGDs";
    public static final String NUMBER_OF_INCLUSION_DEPS = "#Inclusion Dependencies in Target TGDs";
    public static final String NUMBER_OF_LINEAR_TGDS = "#Linear TGDs in Target TGDs";
    public static final String NUMBER_OF_EXTEGDS = "#Extended EGDs";
    public static final String NUMBER_OF_EGDS = "#EGDs";
    public static final String NUMBER_OF_EXTEGDS_FDS = "#Functional Dependencies in Ext. EGDs";
    public static final String NUMBER_OF_EGDS_FDS = "#Functional Dependencies in EGDs";
    public static final String NUMBER_OF_QUERIES = "#Queries";
    public static final String NUMBER_OF_DCS = "#Denial Constraints";
    ...
    public static final String NUMBER_OF_GREEDY_SCENARIOS = "#DED Greedy Scenarios";
    public static final String NUMBER_OF_EXECUTED_GREEDY_SCENARIOS = "#Executed DED greedy Scenarios";
    public static final String NUMBER_OF_FAILED_GREEDY_SCENARIOS = "#Failed DED greedy Scenarios";
    /////
    ...
    public String toString() {
        ...
        appendStat(NUMBER_OF_SOURCE_TABLES, "", sb, printedStats);
        appendStat(NUMBER_OF_SOURCE_ATTRIBUTES, "", sb, printedStats);
        appendStat(NUMBER_OF_TARGET_TABLES, "", sb, printedStats);
        appendStat(NUMBER_OF_TARGET_ATTRIBUTES, "", sb, printedStats);
        appendStat(NUMBER_OF_STTGDS, "", sb, printedStats);
        appendStat(NUMBER_OF_EXTGDS, "", sb, printedStats);
        appendStat(NUMBER_OF_INCLUSION_DEPS, "", sb, printedStats);
        appendStat(NUMBER_OF_LINEAR_TGDS, "", sb, printedStats);
        appendStat(NUMBER_OF_EGDS, "", sb, printedStats);
        appendStat(NUMBER_OF_EGDS_FDS, "", sb, printedStats);
