...
public class ChangeCellDEProxy extends ChangeCell {

    private static Logger logger = LoggerFactory.getLogger(ChangeCellDEProxy.class);

    public ChangeCellDEProxy(IInsertTuple insertOperator, IBatchInsert batchInsertOperator, IOccurrenceHandler occurrenceHandler) {
