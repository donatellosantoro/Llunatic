...
public class GreedyMultiStepJCSCacheManager extends AbstractGreedyCacheManager {

    private static Logger logger = LoggerFactory.getLogger(GreedyMultiStepJCSCacheManager.class);
    ...
    public GreedyMultiStepJCSCacheManager(IRunQuery queryRunner) {
        super(queryRunner);
        try {
