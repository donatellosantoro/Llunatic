...
//        List<Expression> selections = new ArrayList<Expression>();
//        Expression stepExpression = new Expression("startswith(\"" + stepId + "\", " + SpeedyConstants.STEP + ")");
//        stepExpression.changeVariableDescription(SpeedyConstants.STEP, new AttributeRef(LunaticConstants.CELLGROUP_TABLE, SpeedyConstants.STEP));
...
//        AttributeRef step = new AttributeRef(LunaticConstants.CELLGROUP_TABLE, SpeedyConstants.STEP);
