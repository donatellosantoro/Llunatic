...
//        if (queryRunner.isUseTrigger( )) {
    ...
    private IValue findClusterIdInTable(String table, CellRef cell, String stepId, IDatabase deltaDB) {
        ...
        oidExpression.setVariableDescription(LunaticConstants.CELL_OID, new AttributeRef(table, LunaticConstants.CELL_OID));
        Expression tableExpression = new Expression(LunaticConstants.CELL_TABLE + " == \"" + cell.getAttributeRef().getTableName() + "\"");
        tableExpression.setVariableDescription(LunaticConstants.CELL_TABLE, new AttributeRef(table, LunaticConstants.CELL_TABLE));
        Expression attributeExpression = new Expression(LunaticConstants.CELL_ATTRIBUTE + " == \"" + cell.getAttributeRef().getName() + "\"");
        attributeExpression.setVariableDescription(LunaticConstants.CELL_ATTRIBUTE, new AttributeRef(table, LunaticConstants.CELL_ATTRIBUTE));
...
//        Expression valueExpression = new Expression(LunaticConstants.CELL_VALUE + " == \"" + cellGroup.getValue() + "\"");
        ...
        valueExpression.setVariableDescription(LunaticConstants.GROUP_ID, new AttributeRef(table, LunaticConstants.GROUP_ID));
        selections.add(stepExpression);
    ...
    private IAlgebraOperator generateUpdateQuery(CellRef cellRef, String table, String stepId) {
        ...
        oidExpression.setVariableDescription(LunaticConstants.CELL_OID, new AttributeRef(tableAlias, LunaticConstants.CELL_OID));
        Expression tableExpression = new Expression(LunaticConstants.CELL_TABLE + " == \"" + cellRef.getAttributeRef().getTableName() + "\"");
        tableExpression.setVariableDescription(LunaticConstants.CELL_TABLE, new AttributeRef(tableAlias, LunaticConstants.CELL_TABLE));
        Expression attributeExpression = new Expression(LunaticConstants.CELL_ATTRIBUTE + " == \"" + cellRef.getAttributeRef().getName() + "\"");
        attributeExpression.setVariableDescription(LunaticConstants.CELL_ATTRIBUTE, new AttributeRef(tableAlias, LunaticConstants.CELL_ATTRIBUTE));
        selections.add(stepExpression);
        selections.add(oidExpression);
        selections.add(tableExpression);
        selections.add(attributeExpression);
