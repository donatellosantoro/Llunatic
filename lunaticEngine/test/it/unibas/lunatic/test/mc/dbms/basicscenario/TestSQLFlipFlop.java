...
//        Scenario scenario = UtilityTest.loadScenarioFromResources(References.flipflop_dmbs, true);
...
//    }
    ...
    public void testScenarioContraddicting() throws Exception {
        Scenario scenario = UtilityTest.loadScenarioFromResources(References.contraddicting_dmbs, true);
        setConfigurationForTest(scenario);
