...
public class TestSQLPersonsDeps06b extends CheckExpectedSolutionsTest {

    private static Logger logger = LoggerFactory.getLogger(TestSQLPersonsDeps06b.class);

    public void test() throws Exception {
        String scenarioName = "persons-deps-06b";
        Scenario scenario = UtilityTest.loadScenarioFromResources(References.persons_deps_06b_dbms, true);
