...
public class TestSQLPersonsDeps04 extends CheckExpectedSolutionsTest {

    private static Logger logger = LoggerFactory.getLogger(TestSQLPersonsDeps04.class);

    public void test04() throws Exception { //Multiple FDs
        String scenarioName = "persons-deps-04";
        Scenario scenario = UtilityTest.loadScenarioFromResources(References.persons_deps_04_dbms, true);
