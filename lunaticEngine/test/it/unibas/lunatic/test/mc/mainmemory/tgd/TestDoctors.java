...
//        Map<String, List<PrecisionAndRecall>> quality = compareWithExpectedInstances(result, "expected", Arrays.asList(new String[]{LunaticConstants.OID, LunaticConstants.TID}), 1.0, false);
