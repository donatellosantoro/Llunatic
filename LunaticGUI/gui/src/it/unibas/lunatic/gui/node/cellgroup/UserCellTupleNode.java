...
public class UserCellTupleNode extends AbstractNode {

    private final Cell cell;
    private final StepCellGroupNode stepCellGroup;
    private Action[] actions = new Action[]{Actions.forID("Window", R.ActionId.SHOW_USER_CELL_TUPLE)};

    public UserCellTupleNode(Cell key, StepCellGroupNode node) {
        super(Children.LEAF);
        this.cell = key;
